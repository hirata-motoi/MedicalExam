package Test::MedicalExam::Loader::DB;
use strict;
use warnings;
...
sub load {
    ...
    my $mysqld = Test::MedicalExam::mysqld->new;
    $self->mysqld($mysqld);
    ...
    $self->rewrite_resolver($MedicalExam::DBI::resolver);
    $self;
}
...
sub _load_sql {
    ...
    my $module = Test::MedicalExam->module_name(@module_name);
...
sub _loaded_resolver {
    ...
    my $resolver = $LOADED_RESOLVER || Test::MedicalExam::DBHResolver->new;
    return $resolver;
}
